...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_pyluvnxz {
        ...
        private FastObjectFactory_app_web_pyluvnxz() {
        }
        
        static object Create_ASP_genericinquiry_genericinquiry_aspx() {
            return new ASP.genericinquiry_genericinquiry_aspx();
        }
    }
}
