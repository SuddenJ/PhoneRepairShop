...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_tklu1y5i {
        ...
        private FastObjectFactory_app_web_tklu1y5i() {
        }
        
        static object Create_ASP_externalresource_externalresource_aspx() {
            return new ASP.externalresource_externalresource_aspx();
        }
    }
}
