...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_4set114x {
        ...
        private FastObjectFactory_app_web_4set114x() {
        }
        
        static object Create_ASP_app_data_templates_tab_pages_screenid_aspx() {
            return new ASP.app_data_templates_tab_pages_screenid_aspx();
        }
    }
}
