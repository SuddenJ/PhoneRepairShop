...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_qmovmefd {
        ...
        private FastObjectFactory_app_web_qmovmefd() {
        }
        
        static object Create_ASP_app_data_templates_t_pages_screenid_aspx() {
            return new ASP.app_data_templates_t_pages_screenid_aspx();
        }
    }
}
