...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_ivb2rgza {
        ...
        private FastObjectFactory_app_web_ivb2rgza() {
        }
        
        static object Create_ASP_app_data_templates_form_pages_screenid_aspx() {
            return new ASP.app_data_templates_form_pages_screenid_aspx();
        }
    }
}
