...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_upkhj2kj {
        ...
        private FastObjectFactory_app_web_upkhj2kj() {
        }
        
        static object Create_ASP_pivot_pivot_aspx() {
            return new ASP.pivot_pivot_aspx();
        }
    }
}
