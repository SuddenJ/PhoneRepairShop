...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_ocuqtl5z {
        ...
        private FastObjectFactory_app_web_ocuqtl5z() {
        }
        
        static object Create_ASP_app_data_templates_formgrid_pages_screenid_aspx() {
            return new ASP.app_data_templates_formgrid_pages_screenid_aspx();
        }
    }
}
