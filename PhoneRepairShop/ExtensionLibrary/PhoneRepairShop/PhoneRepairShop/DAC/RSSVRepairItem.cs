...
namespace PhoneRepairShop.DAC
{
    [PXCacheName("Repair Item")]
    internal class RSSVRepairItem : IBqlTable
    {
        #region ServiceID
        [PXDBInt(IsKey = true)]
        [PXDBDefault(typeof(RSSVRepairPrice.serviceID))]
        [PXParent(typeof(SelectFrom<RSSVRepairPrice>.Where<RSSVRepairPrice.serviceID.IsEqual<RSSVRepairItem.serviceID>.And<RSSVRepairPrice.deviceID.IsEqual<RSSVRepairItem.deviceID>>>))]
        ...
        [PXRestrictor(typeof(
            Where<InventoryItemExt.usrRepairItem.IsEqual<True>.
                And<Brackets<RSSVRepairItem.repairItemType.FromCurrent.IsNull.Or<InventoryItemExt.usrRepairItemType.IsEqual<RSSVRepairItem.repairItemType.FromCurrent>>>>>),Messages.StockItemIncorrectRepairItemType,typeof(RSSVRepairItem.repairItemType))]
